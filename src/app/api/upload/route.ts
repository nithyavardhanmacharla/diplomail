...
import { saveUploadedPdfFile, saveBatch, getSavedSmtpConfig, getAllTemplates, getUploadedPdfBuffer } from '@/lib/storage';
...
export async function GET(req: NextRequest) {
  try {
    ...
    const buffer = getUploadedPdfBuffer(pdfPath);
    if (!buffer) {
